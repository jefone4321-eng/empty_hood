<footer class="site-footer">
  <div class="footer-brand">
    <img src="../images/hLogo.svg" alt="Empty Hood logo">
    <p class="footer-name">EMPTY HOOD</p>
    <p class="footer-tagline">BUILT DIFFERENT.</p>
  ...
  <div class="footer-col">
    ...
    <a href="returns.php">Return & Exchanges</a>
  ...
  <div class="footer-col">
    ...
    <a href="stockist.php">Stockist</a>
