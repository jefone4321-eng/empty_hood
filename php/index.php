...
<section id="home" class="hero">
    <div class="hero-text"><img src="../images/hLogo.svg">
        ...
        <?php if (isset($_SESSION['user_id'])): ?>
            <h1>WELCOME BACK, <br><?php echo strtoupper(htmlspecialchars($_SESSION['user_name'])); ?></h1>
            <p class="eyebrow"> READY FOR YOUR NEXT DROP?</p>
        <?php else: ?>
            <h1>EMPTY HOOD</h1>
...
<section id="about" class="our-story">
    <div class="our-story-text">
        ...
        <p class="our-story-body">
            empty-hood is more than just a brand. It's a mindset. A reminder that even when you feel empty inside,
            you're still built different. We create pieces for those who move in silence, but have a legacy.
        </p>
                ...
                <div class="review-card <?php echo $index === 1 ? 'featured' : ''; ?>">
                    <div class="review-top">
                        ...
                        <div>
                            ...
                            <p class="review-date"><?php echo htmlspecialchars($review['name']); ?> ·
                                <?php echo date("M j, Y", strtotime($review['created_at'])); ?></p>
                        </div>
                    </div>
