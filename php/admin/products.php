...
<table class="admin-table">
    <tr>
        <th>Image</th><th>Name</th><th>Price</th><th>Category</th><th>Collection</th><th>Actions</th>
    </tr>
    <?php foreach ($products as $product): ?>
        <tr>
            ...
            <td>
                ...
                <form method="post" action="delete_product.php" onsubmit="return confirm('Delete this product?');" style="display:inline">
