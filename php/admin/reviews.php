...
<table class="admin-table">
    <tr><th>Customer</th><th>Rating</th><th>Review</th><th>Date</th><th>Actions</th></tr>
    <?php foreach ($reviews as $review): ?>
        <tr>
            ...
            <td>
                <form method="post" action="delete_review.php" onsubmit="return confirm('Delete this review?');" style="display:inline">
